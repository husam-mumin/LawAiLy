      ...
      >
        <div className=" md:w-[36rem] mx-4 md:mx-auto">
          {Messages.map((msg, index) => (
            <div
              key={msg._id}
              className={`p-4 mb-8 rounded-lg shadow-sm bg-white border flex flex-col gap-2 relative ${
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs text-gray-400 ml-2">
                  {msg.createAt ? new Date(msg.createAt).toLocaleString() : ""}
                </span>
              </div>
              {/* Message Content */}
                  ...
                  <div className="flex-1">
                    ...
                    {msg.response.isGood !== null && (
                      <div className="text-xs mt-2">
                        التقييم:{" "}
                        {msg.response.isGood ? (
                          <span className="text-green-600 font-bold">جيد</span>
                        ) : (
                          <span className="text-red-600 font-bold">
                            غير جيد
                          </span>
