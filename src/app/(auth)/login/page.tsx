...
export default function page() {
  return (
    <div dir="rtl" className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-blue-50 to-white overflow-hidden">
      <div className="relative w-full max-w-md mx-auto bg-white rounded-2xl shadow-xl px-4 sm:px-8 py-8 sm:py-10 flex flex-col items-center gap-6">
        ...
        <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 opacity-30 pointer-events-none z-0 max-w-[90%] overflow-hidden">
          ...
          >
            <ellipse cx="35" cy="47" rx="28" ry="3" fill="#A3A3A3" fillOpacity="0.2" />
            <ellipse cx="35" cy="35" rx="20" ry="12" fill="#6EC6FF" />
            <ellipse cx="35" cy="35" rx="20" ry="12" fill="url(#planetGradient)" />
            <ellipse cx="35" cy="35" rx="14" ry="7" fill="#FFF59D" fillOpacity="0.2" />
            <ellipse cx="50" cy="30" rx="3" ry="1.5" fill="#FFF" fillOpacity="0.4" />
            <ellipse cx="25" cy="40" rx="2.5" ry="1" fill="#FFF" fillOpacity="0.3" />
            <defs>
              <linearGradient id="planetGradient" x1="15" y1="23" x2="55" y2="47" gradientUnits="userSpaceOnUse">
